...
LangString D_DLCS 1041 "Dreamcast DLC content ダウンロード中..."
...
LangString D_STEAMTOOLS 1041 "SADX Steam ツール ダウンロード中..."
...
LangString MSG_FOLDER_NOTFOUND 1041 "セットアップ中にソニックアドベンチャー DX のインストール場所を検出できませんでした。手動でインストール場所を選択してください。$\r$\n\
$\r$\nソニックアドベンチャー DX のレアバージョン（Steam 以外のデジタルダウンロードなど）をお持ちの方、またはこれがバグだと思われる方は、PkR (Twitter ID @pkr_sadx)までご連絡ください。"
...
LangString ERR_D_DLCS 1041 "初代ソニックアドベンチャー DLC content ダウンロードに失敗しました: $DownloadErrorCode. 別の Mod のインストールを続けますか?"
...
LangString DESC_EEC 1041 "エメラルドコーストの外観を改善し、ドリームキャスト版にあった波浪エフェクトを復活します。 $\r$\n\
$\r$\n\
この Mod はバニラ(オリジナル)版ソニックアドベンチャー DX 専用です、ドリームキャスト版 Mod で似たような水表現が欲しい場合は SADX Style Water を使用してください。"
...
LangString DE_E_DLCS 1041 "初代ソニックアドベンチャー DLC Content 展開中..."
