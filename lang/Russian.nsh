...
LangString D_STEAMTOOLS 1049 "Скачивание SADX Steam tools..."
...
LangString MSG_FOLDER_NOTFOUND 1049 "Программа установки не обнаружила SADX. Выберите папку для установки вручную.$\r$\n\
$\r$\nЕсли у вас установлена редкая версия SADX (например, цифровая версия не из Steam) или вы считаете, что это ошибка инсталлятора — свяжитесь с PkR (@pkr_sadx)."
...
LangString DESC_EEC 1049 "Улучшает вид Изумрудного Побережья и добавляет эффект волны из Dreamcast-версии. $\r$\n\
$\r$\n\
Этот мод предназначен только для оригинальной SADX. Используйте настройку SADX Style Water в DC Conversion, если хотите похожую воду в Dreamcast-модах."
...
LangString DE_E_DLCS 1049 "Извлечение SA1 DLC Content..."
