...
install:
  ...
  IfFileExists "$INSTDIR\sonic.exe" sadx2004check missingfiles
...
steamcheck:
  ...
  IfFileExists "$INSTDIR\DLC\re-us2.sfd" +2 0
	...
	;Check ADX/WMA music
  IfFileExists "$INSTDIR\SoundData\bgm\wma\option.adx" +2 0
  ...
  IfFileExists "$INSTDIR\SoundData\voice_us\wma\0000.adx" +2 0
